...
export class IdeaService {
  ...
  get_all_admin_main_walls(): Observable<ApiResponse> {
  return this.http.get<ApiResponse>(this.get_admin_wall);
} 
  update_user_idea(payload:any):Observable<ApiResponse>{
    return this.http.post<ApiResponse>(this.update_idea_status,payload)
  }
  remerge_these_ideas(payload:any): Observable<ApiResponse>{
    return this.http.post<ApiResponse>(this.remerge_ideas, payload)
  }
